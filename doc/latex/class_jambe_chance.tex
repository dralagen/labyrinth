...
\doxyref{Jambe\-Chance}{p.}{class_jambe_chance} herite de \doxyref{Jambe}{p.}{class_jambe}.  
...
\index{Jambe\-Chance@{Jambe\-Chance}!$\sim$\-Jambe\-Chance@{$\sim$\-Jambe\-Chance}}
\index{$\sim$\-Jambe\-Chance@{$\sim$\-Jambe\-Chance}!JambeChance@{Jambe\-Chance}}
\subsubsection[{$\sim$\-Jambe\-Chance}]{\setlength{\rightskip}{0pt plus 5cm}Jambe\-Chance\-::$\sim$\-Jambe\-Chance (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{class_jambe_chance_aba05b0a36b6782ed263bc342884fd0cf}
...
\item 
src/{\bf Jambe\-Chance.\-hpp}\item 
src/{\bf Jambe\-Chance.\-cpp}\end{DoxyCompactItemize}
