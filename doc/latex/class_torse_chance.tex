...
\doxyref{Torse\-Chance}{p.}{class_torse_chance} herite de \doxyref{Torse}{p.}{class_torse}.  
...
\index{Torse\-Chance@{Torse\-Chance}!$\sim$\-Torse\-Chance@{$\sim$\-Torse\-Chance}}
\index{$\sim$\-Torse\-Chance@{$\sim$\-Torse\-Chance}!TorseChance@{Torse\-Chance}}
\subsubsection[{$\sim$\-Torse\-Chance}]{\setlength{\rightskip}{0pt plus 5cm}Torse\-Chance\-::$\sim$\-Torse\-Chance (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\label{class_torse_chance_a832abc37ee876c13e78c7a504f184d3b}
...
\item 
src/{\bf Torse\-Chance.\-hpp}\item 
src/{\bf Torse\-Chance.\-cpp}\end{DoxyCompactItemize}
